...
pub struct FbxLoaderSettings {
    ...
    /// Whether helper/background geometry should be imported alongside the
    /// primary model. This is enabled by default for backwards compatibility;
    /// editor and runtime previews opt out explicitly.
    #[serde(default = "default_load_auxiliary_geometry")]
    pub load_auxiliary_geometry: bool,
...
impl Default for FbxLoaderSettings {
    fn default() -> Self {
        Self {
            ...
            load_auxiliary_geometry: default_load_auxiliary_geometry(),
            load_cameras: true,
            load_lights: true,
...
const fn default_load_auxiliary_geometry() -> bool {
    true
}
